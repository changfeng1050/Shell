...
public class Shell {
     ...
     * @throws com.example.changfeng.shell.Shell.ShellException
     */
    ...
    /**
     * Sets the shell's {@link com.example.changfeng.shell.Shell.OUTPUT output stream}.  Default value is STDOUT.
     *
